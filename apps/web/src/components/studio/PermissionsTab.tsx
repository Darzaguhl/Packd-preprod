...
const ALL_PERMS: PermDef[] = [
  ...
  { label: 'Grant credits',           description: 'Manually grant credits (e.g. goodwill, corrections)',   instructor: 'canGrantCredits',     fronthost: 'canGrantCredits' },
  ...
  { label: 'Export data',             description: 'Download member, attendance and revenue CSV exports',   fronthost: 'canExportData' },
